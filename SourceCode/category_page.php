		...
		<div class="filter-content collapse show" id="collapse_3" >
			<div class="card-body">
				...
				<div class="form-group text-right col-md-6">
				  ...
				  <input class="form-control" value="<?php echo $cat_id ?>"  type="number" name="catID" hidden>
				</div>
				</div> <!-- form-row.// -->



				<button class="btn btn-block btn-lg btn-success">Apply</button>	</form >
			</div><!-- card-body.// -->
		</div>
...
<header class="border-bottom mb-4 pb-3">
		<div class="form-inline">
			...
			<span class="mr-md-auto" style="font-weight:900;font-size:large;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;( <?php echo  $row["COUNT(product_id)"] ?>  )
			 &nbsp;Items found on Watches Category  </span>
